...
<head>
    ...
    <title>BeeTraining Webshop - BeeCare & Feeding</title>
    <link rel="stylesheet" href="styles.css">
    <link rel="stylesheet" href="beecare.css">
</head>
<body>
    <div class="container">
        <header>
        ...
        <h2 class="page-title">BeeCare & Feeding</h2>
    ...
    <script>
        ...
        grid.innerHTML = '';
        products
            .filter(prod => prod.category === "beecare")
            .forEach(prod => {
                grid.innerHTML += `
